# Project-Management — The Agency

The **project management** department from [agency-agents](https://github.com/msitarzewski/agency-agents), bundling 7 specialist subagents.
