# Game-Development — The Agency

The **game development** department from [agency-agents](https://github.com/msitarzewski/agency-agents), bundling 20 specialist subagents.

Imported from https://github.com/msitarzewski/agency-agents (MIT, © AgentLand Contributors).

Each game engine is also published as its own box (a subset of this department):
`agency-agents/Blender`, `agency-agents/Godot`, `agency-agents/Roblox-Studio`,
`agency-agents/Unity`, `agency-agents/Unreal-Engine`. Install one engine, or this
box for the whole department (engines + the engine-agnostic agents).
