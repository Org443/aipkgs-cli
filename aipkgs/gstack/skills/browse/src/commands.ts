...
export const COMMAND_DESCRIPTIONS: Record<string, { category: string; description: string; usage?: string }> = {
  ...
  data: {
    category: 'Reading',
    description: 'Structured data: JSON-LD, Open Graph, Twitter Cards, meta tags',
  ...
  screenshot: {
    ...
    usage: 'screenshot [--selector <css>] [--viewport] [--clip x,y,w,h] [--base64] [selector|@ref] [path]',
  },
  pdf: {
    category: 'Visual',
    description:
  ...
  'tab-each': {
    category: 'Tabs',
    description: 'Run a command on every open tab. Returns JSON with per-tab results.',
  ...
  prettyscreenshot: {
    ...
    usage: 'prettyscreenshot [--scroll-to sel|text] [--cleanup] [--hide sel...] [--width px] [path]',
  },
  // UX Audit
  'ux-audit': {
    category: 'Inspection',
  ...
  'domain-skill': {
    ...
    usage: 'domain-skill save|list|show|edit|promote-to-global|rollback|rm <host?>',
  },
