...
const STOP_LOSS_ITER = process.env.GSTACK_BENCH_STOP_LOSS_ITER ? Number(process.env.GSTACK_BENCH_STOP_LOSS_ITER) : 0;
...
const TESTSAVANT_MODEL = path.join(os.homedir(), '.gstack', 'models', 'testsavant-small', 'onnx', 'model.onnx');
